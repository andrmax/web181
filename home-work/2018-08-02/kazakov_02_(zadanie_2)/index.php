...
foreach ($products as $product) {
    ...
    //Кроме того, если цены будут отличаться только цифрами после запятой, то использование цены в
    ...
    //ключей (для сортировки) можно сначала помножить цену на 1000, а потом использовать как ключ.
    ...
    //повторяющимся значениям минимум 9 раз).
