...
/*Задание:
Выведите числа от 1 до 100 в 4 столбца.
Можно использовать теги, можно без тегов, как угодно,
главное, чтобы визуально было ясно, что числа расположены в столбцах.
*/
