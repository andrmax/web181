...
for ( $i = 0; $i <= 100; $i ++ ) { //цикл от нуля до ста
	if ( $i % 2 == 0 ) {
		echo $i . '<br>';
	} //проверка на четность и вывод в столбец
}
echo "<hr>";
...
foreach ( $arr6 as $value ) {
	...
	if ( in_array( $numm, $needle ) ) {   // если переменная numm равна 1 или 3 или 5 выводим ///Такая запись не сработала, можете объяснить почему?
		echo $value . ' ';
	}
}
echo "<hr>";
